...
int Test_Lsrp_den520d() {
    std::cout << "####### Moving ai test Begin #######" << std::endl;
    std::string MapPath = "C:/Users/David Zhou/Documents/GitHub/public_LSRP/data/maps/empty-16-16.map";
    std::ofstream output_file("C:/Users/David Zhou/Documents/GitHub/public_LSRP/lsrp-empty-baseline2-results.txt");
    ...
    for (int n = 10; n <= 120; n += 10) {
        ...
        for (int i = 1; i <= 25; ++i) {
            std::string ScenPath = R"(C:/Users/David Zhou/Documents/GitHub/public_LSRP/data/scen/empty-16-16-scen-random/empty-16-16-random-)" + std::to_string(i) + ".scen";
            raplab::Grid2d g;
            std::vector<std::vector<double>> occupancy_grid;
            raplab::LoadMap_MovingAI(MapPath, &occupancy_grid);
            g.SetOccuGridPtr(&occupancy_grid);
